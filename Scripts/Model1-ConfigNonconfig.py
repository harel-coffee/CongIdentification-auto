...
for i in range(100):
    ...
    DTM.to_csv('Features-After-correlation.csv')
    ...
    robjects.r.source("Redundancy.R", encoding="utf-8")
    # Loading the function we have defined in R.
    redundant_function_r = robjects.globalenv['redundant']
    df = pd.read_csv("Features-After-correlation.csv")
    ...
    # print(col)
    # columns.append(col)
    # for i in range(0,len(DTM.columns)):
    # print(col)
    # string=str(i)
    # median=DTM.columns[i].median()
    # print(median)
    # colname = DTM.columns[i]
    # print(colname)
    # medians.append(median)

    # for i in columns:
    # print(DTM['grade'].median())
    ...
    # RemainingFeatures=[]
    # FeatureToBeInvestigated=[]
    # for OtherFeatures in DTM.columns:
    # print(OtherFeatures)
    # RemainingFeatures.append(OtherFeatures)
    # print(RemainingFeatures)
    # FeatureToBeInvestigated.append(RemainingFeatures[i])
    # del RemainingFeatures[i]
    # print(RemainingFeatures)
    # loadings=do_analysis(DTM,FeatureToBeInvestigated,RemainingFeatures)
    # print(loadings)
    # print(rdap)
    # Stepwise selection of variables, complete data, environmental, geographic and dummy variables
    # RDA1=rda(FeatureToBeInvestigated,RemainingFeatures)
    # RDA2=rda(FeatureToBeInvestigated,RemainingFeatures)
    ...
    # X_train, y_train = SMOTE(k_neighbors=2).fit_resample(X_trainF, y_train)
    ...
    # auc = metrics.roc_auc_score(y_test,predicted_prob, average= 'macro')
